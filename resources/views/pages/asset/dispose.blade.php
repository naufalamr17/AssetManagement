                                    ...
                                    <tbody>
                                        ...
                                        <tr class="text-center" style="font-size: 14px;">
                                            ...
                                            <td>
                                                ...
                                                @elseif ((Auth::check() && Auth::user()->status != 'Viewers') && (strtoupper($item->approval) === 'APPROVE BY DEPUTY GENERAL MANAGER' || strtoupper($item->approval) === 'APPROVE BY MANAGER' || strtoupper($item->approval) === 'APPROVE BY SUPERVISOR'))
